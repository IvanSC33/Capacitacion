...
const created = context.NotificationRepository.create({ id: 'NOTIF-OTHER-EMP-FAIL', employeeId: 'EMP-0004001', tenantId: 'TEN-001', read: false });
console.log('Created notif:', created);
const markRes = context.NotificationService.markAsRead('NOTIF-OTHER-EMP-FAIL');
