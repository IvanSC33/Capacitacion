...
console.log('checkScope SELF:', context.AuthorizationService.checkScope('SELF', { employeeId: 'EMP-0004001' }));
console.log('checkScope TEAM:', context.AuthorizationService.checkScope('TEAM', { employeeId: 'EMP-0004001' }));
console.log('markAsRead res:', context.NotificationService.markAsRead('NOTIF-OTHER-EMP-FAIL'));
