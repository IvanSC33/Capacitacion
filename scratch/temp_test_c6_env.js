...
const AuditRepository = { create: () => {}, logSecurity: () => {} };



module.exports = {
    SEED_MOCK_DB, EventBus, EnrollmentService, ProgressService, AssignmentService,
    TenantContext, AuthorizationService, AppState,
    ActivityProgressRepository, UnitRepository, ActivityRepository,
    EnrollmentRepository, CourseRepository, CourseVersionRepository,
    CertificationEligibilityService: typeof CertificationEligibilityService !== 'undefined' ? CertificationEligibilityService : null,
    CertificationService, CertificationRequirementRepository, CertificateRepository,
    EvidenceRepository, AssessmentRepository, AttemptRepository,
    AuditRepository, CONFIG, createServiceError, createServiceResult, MockDB
};
