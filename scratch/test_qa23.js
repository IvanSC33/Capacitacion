...
vm.runInContext(`
    ...
    console.log("Includes No disponible:", incHtml.includes("No disponible"));
    console.log("Includes Sin descripción disponible.:", incHtml.includes("Sin descripción disponible."));
    console.log("Includes undefined:", incHtml.includes("undefined"));
    console.log("Includes null:", incHtml.includes("null"));
`, context);
