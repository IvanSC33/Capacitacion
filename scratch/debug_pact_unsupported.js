...
context.location.hash = '#/player?id=COURSE-PLAYER-PROG';
context.ActivityRepository.create({ id: 'PACT-UNSUPPORTED', unitId: 'UNIT-P-PROG', title: 'Actividad Desconocida', type: 'Unsupported3DGame', order: 7, tenantId: 'TEN-001' });
context.selectPlayerActivity('PACT-UNSUPPORTED');
const htmlRes = context.renderScreenPlayer();
console.log('HTML contains E-11:', htmlRes.includes('E-11'));
console.log('HTML contains No Soportado:', htmlRes.includes('No Soportado'));
