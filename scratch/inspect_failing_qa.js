...
const secRes = context.runSecurityNegativeTests();
console.log("=== SECURITY TESTS ===");
secRes.forEach(t => console.log(`${t.pass ? 'PASS' : 'FAIL'} | ${t.name}`));

const domRes = context.runDomainServicesAndEventBusQA();
console.log("\n=== DOMAIN TESTS (FAILING ONLY) ===");
domRes.filter(t => !t.pass).forEach(t => console.log(`FAIL | ${t.name}`));
